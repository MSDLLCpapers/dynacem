...
You can install the development version of *dynacem* from [GitHub](https://github.com/) as follows. You should then load the package, alongside some other packages used here.
