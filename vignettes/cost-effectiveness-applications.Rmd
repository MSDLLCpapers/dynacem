...
These results show that the new intervention is associated with $`r s1_icost` incremental costs relative to the standard of care (including $`r total(s1_new_daqcost)` of drug acquisition costs for the new intervention) and `r s1_iqaly` incremental QALYs. The cumulative ICER (incremental cost per QALY) is $`r s1_icer` per QALY at the 20 year time horizon.
