...
The budgetary costs in the world with the new intervention are $`r budget_with1@total`, comprising $`r budget_with1_soc@total` in respect of the costs of `r budget_with1_soc@uptake` patients being treated with the SoC, and $`r budget_with1_new@total` in respect of the costs of `r budget_with1_new@uptake` patients being treated with the SoC. The total budget impact is $`r bi1@total`, representing an increase of `r bi1@total/budget_wout1@total *100`%.
...
The budgetary costs in the world with the new intervention are $`r budget_with2@total`, comprising $`r budget_with2_soc@total` in respect of the costs of `r budget_with2_soc@uptake` patients being treated with the SoC, and $`r budget_with2_new@total` in respect of the costs of `r budget_with2_new@uptake` patients being treated with the new treatment. The total budget impact is $`r bi2@total`, representing an increase of `r bi2@total/budget_wout2@total *100`%.
