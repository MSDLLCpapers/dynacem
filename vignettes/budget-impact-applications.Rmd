...
The total budgetary costs in the world without are $`r budget_wout1@total` in respect of `r budget_wout1@uptake` patients.
...
The budgetary costs in the world with the new intervention are $`r budget_with1@total`, comprising $`r budget_with1_soc@total` in respect of the costs of `r with1_soc_daqcost@uptake` patients being treated with the SoC, and $`r budget_with1_new@total` in respect of the costs of `r budget_with1_new@uptake` patients being treated with the SoC. The total budget impact is $`r bi1@total`, representing an increase of `r bi1@total/budget_wout1@total *100`%.
...
The total budgetary costs in the world without are $`r budget_wout2@total` in respect of `r budget_wout2@uptake` patients.
...
The budgetary costs in the world with the new intervention are $`r budget_with2@total`, comprising $`r budget_with2_soc@total` in respect of the costs of `r with2_soc_daqcost@uptake` patients being treated with the SoC, and $`r budget_with2_new@total` in respect of the costs of `r with2_new_daqcost@uptake` patients being treated with the new treatment. The total budget impact is $`r bi2@total`, representing an increase of `r bi2@total/budget_wout2@total *100`%.
...
|:---|:--|------------|------------|
| World without new intervention ||  |  |
| | Standard of Care | `r budget_wout1_soc@total` | `r budget_wout2_soc@total`  |
| | New intervention | 0 | 0 |
| | Total | `r budget_wout1@total` | `r budget_wout2@total` |
| World with new intervention ||  |  |
| | Standard of Care | `r budget_with1_soc@total`  | `r budget_with2_soc@total`  |
| | New intervention | `r budget_with1_new@total` | `r budget_with2_new@total` |
| | Total | `r budget_with1@total` | `r budget_with2_new@total`  |
| Budget impact ||  |  |
| | Standard of Care | `r bi1_soc@total` | `r bi2_soc@total`  |
| | New intervention | `r bi1_new@total` | `r bi2_new@total`  |
| | Absolute impact | `r bi1@total` | `r bi2@total`  |
| | Relative impact (%) | `r ((bi1@total)/(budget_wout1@total)*100)`% | `r ((bi2@total)/(budget_wout2@total)*100)`%  |
