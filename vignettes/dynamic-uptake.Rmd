...
Let us work with the same cashflow as in the Dynamic Pricing vignette, but assume all costs/prices are constant in real terms.
...
: Table: Calculation of NPV from a simple cashflow and given discount rate {#tbl-trisimple}
